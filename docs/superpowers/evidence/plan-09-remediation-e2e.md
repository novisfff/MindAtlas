...
- **Plan 09 code-complete** under default-off trusted mount when suites above pass.  
- **M4 not release-complete** — real project-wide RBAC / authenticated principal dependency still absent.  
- **Plan 10 production cutover blocked** until real principal guard + inventory canary under enforce.
