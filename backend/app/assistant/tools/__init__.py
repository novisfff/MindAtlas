...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "create_relation": ("app.assistant.tools.relation_tools", "create_relation"),
    "query_knowledge_graph": ("app.assistant.tools.kb_tools", "query_knowledge_graph"),
    "generate_weekly_report": ("app.assistant.tools.report_tools", "generate_weekly_report"),
    "generate_monthly_report": ("app.assistant.tools.report_tools", "generate_monthly_report"),
