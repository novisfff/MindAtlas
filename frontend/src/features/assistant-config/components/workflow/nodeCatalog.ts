import { Brain, type LucideIcon, GitBranch, Infinity, RefreshCw, ScanSearch, BookOpen } from 'lucide-react'
import type { NodeType } from '../../api/workflow'

export type NodeCatalogCategory = 'basic' | 'logic' | 'data'
...
export const NODE_CATALOG_CATEGORIES: NodeCatalogCategory[] = ['basic', 'logic', 'data']
