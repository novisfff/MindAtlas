...
test('overview skill is the main router and requires session-visible mindatlas tools', () => {
  ...
  assert.match(content, /run `npm --prefix \.\/integrations\/openclaw-mindatlas run update:openclaw`/i)
  assert.match(content, /`npm --prefix \.\/integrations\/openclaw-mindatlas run setup:openclaw`/i)
})
...
test('dispatcher, summary, retrieval, and auto-capture skills define narrower boundaries', () => {
  ...
  assert.match(dispatcher, /run `npm --prefix \.\/integrations\/openclaw-mindatlas run update:openclaw`/i)
  ...
  assert.match(summary, /update:openclaw/i)
  ...
  assert.match(retrieval, /update:openclaw/i)
  ...
  assert.match(autoCapture, /update:openclaw/i)
})
...
test('README documents reinstall and new-session guidance for plugin and shipped skill upgrades', () => {
  ...
  assert.match(readme, /npm --prefix \.\/integrations\/openclaw-mindatlas run setup:openclaw/i)
  assert.match(readme, /npm --prefix \.\/integrations\/openclaw-mindatlas run update:openclaw/i)
